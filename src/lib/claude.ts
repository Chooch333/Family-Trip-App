...
Accommodation references in stop descriptions: When the day has an accommodation set, you may briefly reference it in stop descriptions for the FIRST stop (e.g. "A 10-minute walk from [hotel name] to start your morning") and LAST stop (e.g. "From here it's a short cab ride back to [hotel name]"). Keep references under 15 words, natural, and not on every single day — only when proximity adds useful context. Never fabricate details about the accommodation.`;
